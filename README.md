...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-1508%20xanh-brightgreen?style=flat-square" alt="tests" />
</p>
...
| Sessions | Đọc lại từng cuộc trò chuyện, xem tóm tắt bot tự dựng, bật/tắt bot theo thread |
...
| | |
|---|---|
| Test đơn vị + tích hợp | **1508**, chạy bằng `node:test`, không framework ngoài |
