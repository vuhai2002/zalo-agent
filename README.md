...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-1562%20xanh-brightgreen?style=flat-square" alt="tests" />
</p>
...
| | |
|---|---|
| Test đơn vị + tích hợp | **1562**, chạy bằng `node:test`, không framework ngoài |
