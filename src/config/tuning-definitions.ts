...
const TUNING_BY_KEY = {
  ...
  VIDEO_MAX_SIZE_MB: {
    ...
    hint: "Lưới đỡ thứ hai cho video ngắn mà nặng. Nguồn không phải lúc nào cũng cho biết dung lượng, nên mức này chỉ chặn được khi biết - không thay thế được trần thời lượng.",
    min: 1,
    max: 2000,
    unit: "MB",
  },
  ...
  VIDEO_MAX_CONCURRENT: {
    ...
    hint: "Quá số này thì xếp hàng chờ. Mỗi lượt tải ăn khoảng 75 MB bộ nhớ bất kể video nặng nhẹ, nên đây là mức quyết định bot chiếm bao nhiêu RAM của máy chủ.",
    min: 1,
    max: 8,
    unit: "lượt",
  },
